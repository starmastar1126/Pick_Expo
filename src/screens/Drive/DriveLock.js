...
import { StatusBar, StyleSheet, ScrollView, View, Text, TouchableOpacity, Image, TextInput } from "react-native";
...
class DriveLock extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <Content style={{ marginTop: -60 }}>
          ...
          <ScrollView contentContainerStyle={styles.main}>
            ...
            <TouchableOpacity
              ...
              onPress={() => this.props.navigation.navigate("DriveNext")}
            >
