...
class CongratulationScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        };
                ...
                <Content>
                    ...
                    <View style={styles.main}>
                        ...
                        <View style={{flexDirection: 'row', marginTop: 20}}>
                            <Icon name='facebook' type='fontisto' color={colors.BLUE.TAB} size={18}/>
                            <Icon name='instagram' type='antdesign' color={colors.RED.DEFAULT} size={20} style={{marginLeft: 10, marginRight: 10}}/>
                            <Icon name='whatsapp' type='font-awesome' color={colors.GREEN.DEFAULT} size={20}/>
                        </View>
                        <TouchableOpacity style={styles.viewButton} onPress={() => this.props.navigation.navigate('DriverView')}>
                            <Text style={{ color: colors.WHITE }}>{i18n.translate('View Profile')}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.viewButton, { marginTop: 10, backgroundColor: colors.BLACK}]} onPress={() => this.props.navigation.navigate('DriverView')}>
